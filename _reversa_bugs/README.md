...
> Gerado pelo Reversa em 2026-09-25. Este arquivo é o contrato do registro de bugs deste projeto.
> Source of truth: cada `<contexto>/bugs/<ID>/bug.md`. Tudo em `generated/` é projeção regenerável.

## Configuração do projeto

```yaml
closure_policy: local-software   # assumida pela rota expressa; confirme na primeira execução completa do /reversa-debugger
